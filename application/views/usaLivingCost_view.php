...
<!--    <div class="row">-->
        ...
        <div class="col-md-12">
            ...
            <!-- Title -->
            <h1 class="mt-4">Cost of Living for International Students in the US</h1>
...
<!--            <h6>Living Expenses</h6>-->
            <p class="lead">
                ...
                Here is a range of costs that the been considered while estimating the living expenses
            </p>
